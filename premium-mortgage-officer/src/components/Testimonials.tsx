...
export const Testimonials = () => {
  const reviews = [
    {
      text: "Crystal made the impossible possible. We had a complicated income situation, but she navigated it with ease. We are now in our dream home thanks to her!",
      author: "Michael & Jessica T.",
      type: "First-Time Buyers"
    },
    {
      text: "As a real estate investor, I need speed and reliability. Crystal delivers both every single time. Her knowledge of the market is unmatched.",
      author: "David R.",
